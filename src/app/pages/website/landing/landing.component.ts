...
@Component({
  ...
  standalone: true,
  imports: [RouterOutlet, RouterLink, CommonModule, FormsModule, ConfirmDialogModule, ButtonModule, DialogModule, CheckboxModule, HeaderComponent, FooterComponent, PhotoSliderComponent, ImageSliderComponent, CarPageComponent, TransparentHeaderComponent],
